...
Below you can find a curated set of varied datasets that you can use for the class assignment and your own research projects. Please make sure to read the underlying documentation describing the information. The list is obviously highly selected based on my own interests and availability, so you are also free to choose your own sources.
...
Recent examples using historical aerial photographs are @sylvester2012, @midgley2017, @pinol2018, @carvalho2021 and @llena2023 that track the temporal evolution of urban areas, crop fields, glacial dynamics, coastal erosion and forest cover (and land abandonment). 

On using satellite imagery check @donaldson2016 and @wuepper2025.
...
- The [Library of Congress Map Collections](https://www.loc.gov/maps/collections)

Check also this blogpost on [Finding historical data IV: A post with cool maps](https://www.broadstreet.blog/p/finding-historical-data-iv-a-post-with-cool-maps).

As examples of projects geo-referencing old maps, see the [Viabundus Project](https://www.degruyter.com/document/doi/10.1515/jbwg-2023-0007/html?lang=en) [@holterman2023]. See also @heblich2021, @redding2024, @siodla2015 and @hornbeck2017. 

More examples can be found in these blog posts by [Alexandra Cirone](https://broadstreet.blog/2021/03/01/finding-historical-data-iv-a-post-with-cool-maps/) and [James Feigenbaum](https://broadstreet.blog/2021/10/06/maps-as-data-ec365/).

Digitising old maps involves two steps: (1) geo-referencing a historical map, that is, adding real-world spatial coordinates, and (2) digitising the spatial features you are interested in using dots, lines or polygons (creating a shapefile). Although this process can be done using R, it is more intuitive using specific GIS software such as [QGIS](https://qgis.org) or [ArcGIS](https://arcgis.com/index.html). The [Programming Historian](https://programminghistorian.org/en/lessons/vector-layers-qgis) and the [Geospatial Historian](https://geospatialhistorian.wordpress.com) offer great tutorials both in QGIS and ArcGIS [@clifford2013; see also @gregory2007]. 

Manually digitising points, lines or polygons is time-consuming. Advances in computational methods enable automatically extracting digital versions from scanned images of historical maps (or aerial images). More details in @hosseini2021, @combes2022, @litvine2024, or @mcdonough2024.
...
These are just some examples. A fine-grain online search, specifying the area, the period and the topic of interest will probably produce more results. Moreover, you can always directly ask authors that have digitised their own maps.
...
- [GeoNorge](https://www.geonorge.no/en) is the place to go regarding map data and other location information in Norway. 
...
Those students with other research interests can choose their data set on their own. The possibilities are endless. Here are just a few additional examples. Make sure that they provide spatial coordinates or that you can get them by other means (i.e. geocoding).

- [Kaggle](https://www.kaggle.com/datasets) or [TidyTuesday](https://github.com/rfordatascience/tidytuesday?tab=readme-ov-file#datasets)  gather a wide variety of data sets. See, for instance, the aerial bombing operations in [World War II](https://www.kaggle.com/datasets/usaf/world-war-ii) or [Vietnam War](https://www.kaggle.com/datasets/usaf/vietnam-war-bombing-operations), or the [Significant earthquakes, 1900-Present](https://www.kaggle.com/datasets/usamabuttar/significant-earthquakes), among many others. You can also check [Data is Plural](https://www.data-is-plural.com/archive/) for a curated list of other data sets, mostly contemporary.

As mentioned above, I encourage you to find your own source of spatial data.